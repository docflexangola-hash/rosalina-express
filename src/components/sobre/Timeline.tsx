    ...
    <section className="w-full bg-surface-container-low border-b-4 border-on-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <span className="font-label-code text-label-code uppercase text-on-surface-variant mt-2">
            {timeline.note}
          </span>
        </div>
          ...
          {timeline.marcos.map((m, i) => (
            <Reveal key={i} stagger={Math.min(i + 1, 6) as 1 | 2 | 3 | 4 | 5 | 6}>
              ...
              >
                ...
                <div className={`flex-1 md:w-1/2 ${i % 2 === 0 ? "md:pl-8" : "md:pr-8"}`}>
                  <div className="bg-surface-container-lowest border-2 border-on-surface p-6 shadow-[4px_4px_0px_0px_#0c1a3b] card-brutal">
                    ...
                    <div className="mt-4 pt-3 border-t-2 border-outline-variant">
                      <span className={`inline-flex items-center gap-2 font-label-code text-label-code uppercase ${
